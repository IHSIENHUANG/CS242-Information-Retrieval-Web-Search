  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Search Results - Hadoop (BM25 + Location)</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="../index.html">Home</a></li>
              <li><i class="fa fa-laptop"></i>Search Results - Hadoop (BM25 + Location)</li>
            </ol>
          </div>
        </div>
	    ...
	    exec("python stem_query.py '$ta1'", $ta2);
            ...
            exec("python data_select_location.py '$ta1'", $output);
            // DEBUG: fetched array
	    // echo $ta1;
