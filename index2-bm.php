...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a class="logo"><span class="lite">Twitter Search Engine</span></a>
      <!--logo end-->
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Search Results - Hadoop (BM25)</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="../index.html">Home</a></li>
              <li><i class="fa fa-laptop"></i>Search Results - Hadoop (BM25)</li>
            </ol>
          </div>
        </div>

        <div class="row">
          <a href="index2-bm.php" class="fill-div">
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
              <div class="info-box blue-bg">
                <i class="fa fa-cloud"></i>
                <div class="count">BM25</div>
                <div class="title">Rerank</div>
              </div> <!--/.info-box-->
            </div> <!--/.col-->
          </a>
          
          <a href="index2-pop.php" class="fill-div">
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
          ...
          <a href="index2-loc.php" class="fill-div">
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
              <div class="info-box brown-bg">
                <i class="fa fa-map-marker"></i>
                <div class="count">BM25 + Loc</div>
                <div class="title">Rerank</div>
              </div> <!--/.info-box-->   
            </div> <!--/.col-->
          </a>
	    ...
	    //putenv("PATH=$PATH:/home/arishen/Downloads/apache-cassandra-3.9/bin");
	    //echo shell_exec("bashscript.sh");
            
            exec("python data_select.py '$ta2[0]'", $output);
	    //echo $ta1."\n";
	    //echo $ta2[0];
	    //print_r($output);
            //DEBUG: fetched array
            ...
            //echo $item_count;
            $b = 0;
            for($a=0; $a<$item_count-1; $a+=6) {
              $rubbish_array[$b] = $output[$a];
              $tweet_id_array[$b] = $output[$a+1];
              $tweet_content_array[$b] = $output[$a+2];
              $followers_array[$b] = $output[$a+3];
              $location_array[$b] = $output[$a+4];
              $time_array[$b] = $output[$a+5];
              $b++;
            }
          }
        ?></p>
